...
public class TestRunnerTest {
    ...
    private final static ClassLinkMetadata ClassExtendingAbstractClass_METADATA = new ClassLinkMetadata(status, "it.javalinux.sibilla.testsupport.ClassExtendingAbstractClass");

    private final static ClassLinkMetadata AbstractClassClassExtendingInterfaceUnderTestWithAddedAnnotations_METADATA = new ClassLinkMetadata(status, "it.javalinux.sibilla.testsupport.AbstractClassClassExtendingInterfaceUnderTestWithAddedAnnotations");

    private final static ClassLinkMetadata InterfaceUnderTestOne_METADATA = new ClassLinkMetadata(status, "it.javalinux.sibilla.testsupport.InterfaceUnderTestOne");
