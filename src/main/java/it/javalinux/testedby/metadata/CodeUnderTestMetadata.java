...
/**
 * It represents the metadata for a unit of code under test (i.e class under test
...
public interface CodeUnderTestMetadata extends Metadata {
    ...
    /**
     * 
     * @return a Collection of {@link TestClassMetadata} of test classes
     *         stressing the represented unit of code. Note that the purpose of
     *         this method is to return metadata of test stressing specifically
